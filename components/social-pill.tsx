...
export const SOCIAL_PLACEHOLDER_HREF = "#";
...
export const SOCIAL_LINK_ITEMS = [
  { label: "LinkedIn", href: SOCIAL_PLACEHOLDER_HREF, icon: linkedInIcon },
  { label: "Instagram", href: SOCIAL_PLACEHOLDER_HREF, icon: instagramIcon },
  { label: "GitHub", href: SOCIAL_PLACEHOLDER_HREF, icon: githubIcon },
  { label: "Email", href: SOCIAL_PLACEHOLDER_HREF, icon: emailIcon },
  { label: "WhatsApp", href: SOCIAL_PLACEHOLDER_HREF, icon: whatsappIcon },
] as const;
  ...
  return (
    <nav aria-label="Social profiles" className={`inline-flex max-w-full ${shell} ${className}`}>
      <ul className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
        {SOCIAL_LINK_ITEMS.map(({ label, href, icon }) => (
          <li key={label}>
